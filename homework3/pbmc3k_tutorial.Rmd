...
plot_order <- paste("Cluster", levels(pbmc$kmeans10))
arranged_plots <- wrap_plots(subcluster_plots[plot_order], ncol = 4)


print(overall_plot)
print(arranged_plots + plot_layout(guides = "collect"))
dev.off()
```
